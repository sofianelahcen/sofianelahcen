...
export const profile = {
  statement:
    "PARIS-BASED MULTIDISCIPLINARY CREATIVE SOFIANE LAHCEN SPECIALISES IN ART DIRECTION FOR FASHION, BEAUTY, AND LUXURY BRANDS. SERVICES SPAN CREATIVE DIRECTION, PHOTOGRAPHY, ADVERTISING AND BRAND STRATEGY.",
